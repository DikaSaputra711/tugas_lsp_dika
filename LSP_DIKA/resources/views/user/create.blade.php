    ...
    <div class="p-4">
        ...
        <form action="{{ route('pendaftaran.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="bg-teal-100 mx-auto p-6 rounded-lg shadow-md max-w-4xl">
                ...
                <div class="mb-4">
                    <button type="submit" class="w-full bg-teal-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">Kirim Pendaftaran</button>
                </div>
            </div>
        </form>
    </div>
