...
return new class extends Migration
{
    ...
    public function down(): void
    {
        ...
        Schema::table('users', function (Blueprint $table) {
            // Hapus kolom baru
            $table->dropColumn(['nama_depan', 'nama_belakang', 'nomor_hp', 'foto_profile']);
            
            // Ubah kolom role dan status ke default semula
            $table->string('role')->default('calon_mahasiswa')->change();
